(() => {
            ...
            function getHeight(showMoreBlock, showMoreContent) {
                ...
                if (showMoreType === "items") {
                    ...
                    for (let index = 1; index < showMoreItems.length; index++) {
                        ...
                        hiddenHeight += showMoreItem.offsetHeight + marginTop + 1;
    ...
    function headerScroll() {
        ...
        const headerShowTimer = header.dataset.scrollShow ? header.dataset.scrollShow : 800;
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        setTimeout((function() {
            line1.style.transition = "stroke-dashoffset 2s ease-in-out";
            line1.style.strokeDashoffset = 0;
            line1.addEventListener("transitionend", (function() {
                line2.style.transition = "stroke-dashoffset 2s ease-in-out";
